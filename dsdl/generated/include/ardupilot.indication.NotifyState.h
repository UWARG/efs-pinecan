...
uint32_t _ardupilot_indication_NotifyState_encode(struct ardupilot_indication_NotifyState* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool _ardupilot_indication_NotifyState_decode(const CanardRxTransfer* transfer, struct ardupilot_indication_NotifyState* msg);

static inline uint32_t ardupilot_indication_NotifyState_encode(struct ardupilot_indication_NotifyState* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
) {

    return _ardupilot_indication_NotifyState_encode(msg, buffer
#if CANARD_ENABLE_TAO_OPTION
    , tao
#endif
    );
...
static inline bool ardupilot_indication_NotifyState_decode(const CanardRxTransfer* transfer, struct ardupilot_indication_NotifyState* msg) {

    return _ardupilot_indication_NotifyState_decode(transfer, msg);

}

#if defined(CANARD_DSDLC_INTERNAL)

static inline void __ardupilot_indication_NotifyState_encode(uint8_t* buffer, uint32_t* bit_ofs, struct ardupilot_indication_NotifyState* msg, bool tao);
static inline bool __ardupilot_indication_NotifyState_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct ardupilot_indication_NotifyState* msg, bool tao);
void __ardupilot_indication_NotifyState_encode(uint8_t* buffer, uint32_t* bit_ofs, struct ardupilot_indication_NotifyState* msg, bool tao) {
...
*/
bool __ardupilot_indication_NotifyState_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct ardupilot_indication_NotifyState* msg, bool tao) {
