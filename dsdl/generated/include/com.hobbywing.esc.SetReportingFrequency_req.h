...
uint32_t _com_hobbywing_esc_SetReportingFrequencyRequest_encode(struct com_hobbywing_esc_SetReportingFrequencyRequest* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool _com_hobbywing_esc_SetReportingFrequencyRequest_decode(const CanardRxTransfer* transfer, struct com_hobbywing_esc_SetReportingFrequencyRequest* msg);

static inline uint32_t com_hobbywing_esc_SetReportingFrequencyRequest_encode(struct com_hobbywing_esc_SetReportingFrequencyRequest* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
) {

    return _com_hobbywing_esc_SetReportingFrequencyRequest_encode(msg, buffer
#if CANARD_ENABLE_TAO_OPTION
    , tao
#endif
    );
...
static inline bool com_hobbywing_esc_SetReportingFrequencyRequest_decode(const CanardRxTransfer* transfer, struct com_hobbywing_esc_SetReportingFrequencyRequest* msg) {

    return _com_hobbywing_esc_SetReportingFrequencyRequest_decode(transfer, msg);

}

#if defined(CANARD_DSDLC_INTERNAL)

static inline void __com_hobbywing_esc_SetReportingFrequencyRequest_encode(uint8_t* buffer, uint32_t* bit_ofs, struct com_hobbywing_esc_SetReportingFrequencyRequest* msg, bool tao);
static inline bool __com_hobbywing_esc_SetReportingFrequencyRequest_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_hobbywing_esc_SetReportingFrequencyRequest* msg, bool tao);
void __com_hobbywing_esc_SetReportingFrequencyRequest_encode(uint8_t* buffer, uint32_t* bit_ofs, struct com_hobbywing_esc_SetReportingFrequencyRequest* msg, bool tao) {
...
*/
bool __com_hobbywing_esc_SetReportingFrequencyRequest_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_hobbywing_esc_SetReportingFrequencyRequest* msg, bool tao) {
