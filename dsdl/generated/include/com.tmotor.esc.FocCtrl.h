...
uint32_t _com_tmotor_esc_FocCtrl_encode(struct com_tmotor_esc_FocCtrl* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool _com_tmotor_esc_FocCtrl_decode(const CanardRxTransfer* transfer, struct com_tmotor_esc_FocCtrl* msg);

static inline uint32_t com_tmotor_esc_FocCtrl_encode(struct com_tmotor_esc_FocCtrl* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
) {

    return _com_tmotor_esc_FocCtrl_encode(msg, buffer
#if CANARD_ENABLE_TAO_OPTION
    , tao
#endif
    );
...
static inline bool com_tmotor_esc_FocCtrl_decode(const CanardRxTransfer* transfer, struct com_tmotor_esc_FocCtrl* msg) {

    return _com_tmotor_esc_FocCtrl_decode(transfer, msg);

}

#if defined(CANARD_DSDLC_INTERNAL)

static inline void __com_tmotor_esc_FocCtrl_encode(uint8_t* buffer, uint32_t* bit_ofs, struct com_tmotor_esc_FocCtrl* msg, bool tao);
static inline bool __com_tmotor_esc_FocCtrl_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_tmotor_esc_FocCtrl* msg, bool tao);
void __com_tmotor_esc_FocCtrl_encode(uint8_t* buffer, uint32_t* bit_ofs, struct com_tmotor_esc_FocCtrl* msg, bool tao) {
...
*/
bool __com_tmotor_esc_FocCtrl_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_tmotor_esc_FocCtrl* msg, bool tao) {
