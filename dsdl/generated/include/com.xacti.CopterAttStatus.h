...
uint32_t _com_xacti_CopterAttStatus_encode(struct com_xacti_CopterAttStatus* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool _com_xacti_CopterAttStatus_decode(const CanardRxTransfer* transfer, struct com_xacti_CopterAttStatus* msg);

static inline uint32_t com_xacti_CopterAttStatus_encode(struct com_xacti_CopterAttStatus* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
) {

    return _com_xacti_CopterAttStatus_encode(msg, buffer
#if CANARD_ENABLE_TAO_OPTION
    , tao
#endif
    );
...
static inline bool com_xacti_CopterAttStatus_decode(const CanardRxTransfer* transfer, struct com_xacti_CopterAttStatus* msg) {

    return _com_xacti_CopterAttStatus_decode(transfer, msg);

}

#if defined(CANARD_DSDLC_INTERNAL)

static inline void __com_xacti_CopterAttStatus_encode(uint8_t* buffer, uint32_t* bit_ofs, struct com_xacti_CopterAttStatus* msg, bool tao);
static inline bool __com_xacti_CopterAttStatus_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_xacti_CopterAttStatus* msg, bool tao);
void __com_xacti_CopterAttStatus_encode(uint8_t* buffer, uint32_t* bit_ofs, struct com_xacti_CopterAttStatus* msg, bool tao) {
...
*/
bool __com_xacti_CopterAttStatus_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct com_xacti_CopterAttStatus* msg, bool tao) {
